    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="w-full px-6 lg:px-20">
        <div className="flex items-center h-20">
          ...
          {/* Right Side - Social Media + Language + Contact */}
          <div className="hidden lg:flex items-center gap-4 flex-shrink-0 ml-auto">
            {/* Social Media Links */}
            <div className="flex items-center gap-3 mr-2">
              <span className={`text-xs font-body font-medium uppercase tracking-wide ${scrolled ? "text-neutral-medium-dark" : "text-neutral-white"}`}>
                {t.nav.followUs}
              </span>
